            ...
            <div class="mx-4 mt-8 p-3 rounded-lg shadow-md" style="background-color: var(--custom-color);">
                ...
                <div class="content-section" data-filter="sidebar-list" style="display: none;">
                    <ul class="p-0 my-4">
                        ...
                        <li class="bg-white p-3 rounded-lg shadow-sm mb-3 flex items-center">
                            <img src="{{ asset('storage/assets/policy management.png') }}" alt="Policy Management Icon" class="w-5 h-5 mr-3">
                            <div>
                        ...
                        <li class="bg-white p-3 rounded-lg shadow-sm mb-3 flex items-center">
                            <img src="{{ asset('storage/assets/content management.png') }}" alt="My Reservations Icon" class="w-5 h-5 mr-3">
                            <div>
                                <div>Content Management</div>
                                <div>Manage system contents such as departmental accent color, reservation span, and department background.</div>
                            </div>
                        </li>
                        <li class="bg-white p-3 rounded-lg shadow-sm mb-3 flex items-center">
                            <img src="{{ asset('storage/assets/account management.png') }}" alt="Reservation Calendar Icon" class="w-5 h-5 mr-3">
                            <div>
                                <div>Account Management</div>
                                <div>Manage user's account information</div>
                            </div>
                        </li>
                        <li class="bg-white p-3 rounded-lg shadow-sm mb-3 flex items-center">
                            <img src="{{ asset('storage/assets/audit trail.png') }}" alt="About Icon" class="w-5 h-5 mr-3">
                            <div>
                                <div>Audit Trail</div>
                                <div>Monitor user's actions and activities.</div>
                            </div>
                        </li>
                        <li class="bg-white p-3 rounded-lg shadow-sm mb-3 flex items-center">
                            <img src="{{ asset('storage/assets/archive feedback.png') }}" alt="Archived Feedbacks Icon" class="w-5 h-5 mr-3">
                            <div>
                                <div>Archived Feedbacks</div>
                                <div>Old feedback entries moved out of the active list for better organization, retained for record-keeping purposes.</div>
                            </div>
                        </li>
                        <li class="bg-white p-3 rounded-lg shadow-sm mb-3 flex items-center">
