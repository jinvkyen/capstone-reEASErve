                        ...
                        <div class="overflow-x-auto w-full">
                            <table class="sm:text-xs lg:text-base text-left w-full text-balance">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('ma.password.change') }}" method="POST">
                                            @csrf
                                            @method('POST')
                                            <!-- Password Modal -->
                                            ...
                                            <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content bg-white shadow-xl font-mont rounded-lg" style="border-radius: 20px;">
            ...
            <div class="modal fade" id="imageModal" tabindex="-1" aria-labelledby="imageModalLabel" aria-hidden="true" data-bs-backdrop="static">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content bg-white shadow-xl font-mont">
                        ...
                        <div class="px-6 py-4">
                            <form id="image-upload-form" action="{{ route('ma.image_upload') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                                @csrf
...
<script>
    ...
    resetImageButton.classList.add('bg-gray-500', 'hover:bg-gray-600');
...
<!-- Change Password and Image Validation -->
@if (session('success'))
<script>
