...
<body class="bg-white font-mont">
    <div class="flex flex-col lg:flex-row">
        ...
        <div class="flex flex-col lg:ml-80 w-full my-4">
            ...
            <div class="flex flex-col p-2 rounded-lg shadow-lg mx-4 mt-8" style="background-color: var(--custom-color);">
                ...
                <div class="flex flex-col sm:flex-row justify-between items-center w-full p-4 font-mont">
                    ...
                    <button
                        class="font-mont text-white bg-300 hover:bg-blue-700 rounded-lg p-2 text-center whitespace-nowrap w-full sm:w-auto text-xs sm:text-sm lg:text-base transition duration-300 ease-in-out"
                        type="button"
                        data-toggle="modal"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-black text-base">
                        <!-- Form for Adding or Editing Policy -->
                        <form method="POST" action="{{ route('admin.add.policy') }}">
                            @csrf
        ...
        <script>
            // Current URL
            const baseUrl = "{{ url('/') }}";
            const editPolicyRoute = "{{ route('admin.edit.policy', ':id') }}";
            const deletePolicyRoute = "{{ route('admin.delete.policy', ':id') }}";
        </script>
                    ...
                    button.addEventListener('click', function() {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                deleteForm.action = "{{ route('admin.delete.policy', ':id') }}".replace(':id', policyId);
