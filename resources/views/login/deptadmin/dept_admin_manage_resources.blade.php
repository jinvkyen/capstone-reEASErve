                    ...
                    <div class="flex flex-col sm:flex-row justify-between space-x-4 items-center w-full mt-2">
                        <div class="flex flex-col relative group dropdown">
                            ...
                            <div class="dropdown-menu ml-3 hidden w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5">
                                <div class="py-1">
                                    <a href="{{ route('admin.add.resources') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 no-underline" style="text-decoration: none;">Add Resource</a>
                                    <a href="{{ route('admin.add.facility') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 no-underline" style="text-decoration: none;">Add Facility</a>
                                </div>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr class="bg-white border-b hover:bg-gray-100">
                                        ...
                                        <td class="px-6 py-4 no-underline text-center">
                                            <a href="{{ route('admin.view.resources', ['resource_id' => $item->resource_id]) }}" class="text-blue-600 hover:underline">
                                    ...
                                    <tr class="no-records" style="display: none">
                                        <td
                                            colspan="7"
                                            class="text-center text-gray-500 font-medium px-6 py-4">
                                            No records found.
                                        </td>
                                    </tr>
                            ...
                            <table id="facilityTable" class="w-full text-sm text-left text-gray-500">
                                ...
                                <tbody>
                                    ...
                                    <tr class="bg-white border-b hover:bg-gray-100">
                                        ...
                                        <td class="px-6 py-4 no-underline text-center">
                                            <a href="{{route('admin.view.facility',['facilities_id' => $facility->facilities_id])}}" class="text-blue-600 hover:underline">
                                                <i class="fs-5 bi bi-eye-fill"></i>
                                            </a>
                                        </td>
                                    </tr>
