...
<body class="bg-white font-mont">
    <div class="flex flex-col lg:flex-row">
        ...
        <div class="flex flex-col flex-1 lg:ml-80 w-full my-4">
            ...
            <!-- Form Content -->
            <form id="editForm" method="POST" action="{{ route('admin.edit.facility')}}" enctype="multipart/form-data">
                @csrf
    ...
    <form id="deleteForm" action="{{ route('admin.delete.facility') }}" method="POST">
        @csrf
        <input type="hidden" name="facilities_id" value="{{ $facility->facilities_id }}">
    </form>
</body>
