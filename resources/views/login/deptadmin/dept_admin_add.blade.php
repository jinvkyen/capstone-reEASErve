                    ...
                    <div class="flex flex-col lg:flex-row w-full">
                        ...
                        <div class="flex flex-col p-2 w-full xl:w-4/12 justify-center items-center relative">
                            <div class="relative flex justify-center items-center flex-col" id="preview">
                                ...
                                <!-- Image Preview -->
                                <img id="image_preview" src="{{ empty($imageSrc) ? asset('storage/assets/default_resource.png') : $imageSrc }}" alt="Image Preview" class="w-64 h-64 min-w-64 min-h-64 object-cover rounded-b-lg">
