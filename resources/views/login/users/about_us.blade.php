                ...
                <div class="content-section" data-filter="sidebar-list" style="display: none;">
                    <ul class="p-0 my-4">
                        <li class="bg-white p-3 rounded-lg shadow-sm mb-3 flex items-center">
                            ...
                            <div>
                                <div>Dashboard</div>
                                <div>Reservation details and general department policies.</div>
                            </div>
                        </li>
                        ...
                        <li class="bg-white p-3 rounded-lg shadow-sm mb-3 flex items-center">
                            ...
                            <div>
                                <div>Student Approval</div>
                                <div>Approve your student's request of resource/s that needs your approval for them to claim the resource/s at the department.</div>
                            </div>
                        </li>
                        @endif
                        <li class="bg-white p-3 rounded-lg shadow-sm mb-3 flex items-center">
                            <img src="{{ asset('storage/assets/resources.png') }}" alt="Reserved Resources Icon" class="w-5 h-5 mr-3">
                            <div>
                                <div>Reserve Resources</div>
                                <div>Make reservations of resources.</div>
                            </div>
                        </li>
                        <li class="bg-white p-3 rounded-lg shadow-sm mb-3 flex items-center">
                            <img src="{{ asset('storage/assets/my reservation.png') }}" alt="My Reservations Icon" class="w-5 h-5 mr-3">
                            <div>
                                <div>My Reservations</div>
                                <div>Manage and monitor your reservation's statuses.</div>
                            </div>
                        </li>
                        <li class="bg-white p-3 rounded-lg shadow-sm mb-3 flex items-center">
