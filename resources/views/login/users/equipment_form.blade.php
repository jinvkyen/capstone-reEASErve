...
<head>
    ...
    <title>Equipment {{$cms['dept_label']}}</title>
...
<body class="bg-white font-mont">
    <div class="flex flex-col lg:flex-row">
        ...
        <div class="flex flex-col lg:ml-80 w-full my-4">
            ...
            <form method="POST" action="{{ route('equipment.request') }}">
                @csrf
                <div class="flex flex-col lg:flex-row p-2 rounded-lg shadow-sm mx-4 mt-8" style="background-color: var(--custom-color);">
                    ...
                    <div class="flex-grow lg:w-8/12 p-2">
                        ...
                        <div class="flex flex-col lg:flex-row lg:items-start w-full items-center">
                            <h3 class="font-semibold ml-1 mt-3 lg:text-2xl sm:text-xl">Equipment</h3>
                        </div>
                        ...
                        <div class="flex flex-col w-full mt-3">
                            ...
                            <div class="p-1 w-full">
                                ...
                                <select class="shadow-lg" id="dropdown-button" name="items[]" multiple>
                                    ...
                                    <option value="{{ $resource_id }}|{{ $resource['resource_name'] }}|{{ $resource['image'] }}">
                                        {{ $resource['resource_name'] }} ({{$resource['serial_number']}})
                                    </option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <div class="flex flex-col p-2 w-full lg:w-4/12 justify-center items-center relative">
                        <!-- Image Container -->
                        <div class="relative flex justify-center items-center flex-col">
                            ...
                            <!-- Image -->
                            <img class="max-h-64 max-w-64 min-w-64 object-contain rounded-lg" id="item-image" src="{{ empty($imageSrc) ? asset('storage/assets/default_resource.png') : $imageSrc }}" alt="Item Image">
                            <!-- Select Item -->
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title font-semibold font" id="policyModalLabel">Terms and Conditions</h4>
...
<?php if (session('conflictList')): ?>
    <script>
        ...
        Swal.fire({
            ...
            html: `<p>The following time slots are already reserved for this resource:</p><br><p>${formattedList}</p>`,
