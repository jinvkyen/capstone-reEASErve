            ...
            <div class="responsive-container w-full lg:p-4 sm:p-0">
                <div class="mb-12">
                    ...
                    <p class="lg:text-lg md:text-2lg sm:text-sm text-left text-200 py-2 text-sm">Enter the code received on your Organizational Email Address.
                        <span class="text-opacity-60 font-semibold text-[#385F6E] underline">Please check your Inbox, Junk, Or Spam.</span>
                    </p>
                </div>
                <form method="POST" action="{{route('system.otp.verify')}}">
                    @csrf
                    <!-- Enter Code -->
                    <div class="mb-8">
                    ...
                    <div class="flex justify-center items-center mt-8 space-x-4">
                        ...
                        <div class="w-full mt-12 align-center self-start lg:text-lg sm:text-sm">
                            <a id="back-login" href="{{ route('system.logout') }}" class="text-gray-600 text-md font-bold hover:text-[#385F6E]">
