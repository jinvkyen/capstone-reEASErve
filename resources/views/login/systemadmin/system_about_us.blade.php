                ...
                <div class="content-section" data-filter="sidebar-list" style="display: none;">
                    <ul class="p-0 my-4">
                        <li class="bg-white p-3 rounded-lg shadow-sm mb-3 flex items-center">
                            <img src="{{ asset('storage/assets/dashboard2.png') }}" alt="Control Panel Icon" class="w-5 h-5 mr-3">
                            <div>
                                <div>Control Panel</div>
                                <div>Manage college information by adding or editing colleges, departments, and chairperson assignments.</div>
                            </div>
                        </li>
                        <li class="bg-white p-3 rounded-lg shadow-sm mb-3 flex items-center">
                            <img src="{{ asset('storage/assets/registration policy.png') }}" alt="Registration Policy Icon" class="w-5 h-5 mr-3">
                            <div>
                                <div>Registration Policy</div>
                                <div>Edit organization's domain name and registration policy.</div>
                            </div>
                        </li>
                        <li class="bg-white p-3 rounded-lg shadow-sm mb-3 flex items-center">
                            <img src="{{ asset('storage/assets/audit trail.png') }}" alt="Audit Trail Icon" class="w-5 h-5 mr-3">
                            <div>
                                <div>Audit Trail</div>
