    ...
    <div class="flex flex-col lg:flex-row">
        ...
        <div class="flex flex-col lg:ml-80 w-full min-w-screen-lg my-4">
            ...
            <div class="bg-custom-color mx-4 mt-4 p-4 rounded-lg shadow-lg" style="background-color: var(--custom-color);">
                <!-- Top Section -->
                <div class="flex flex-col lg:flex-row justify-between font-mont pb-2 space-y-4 lg:space-y-0">
...
<script>
    ...
    document.getElementById("searchInput").addEventListener("keyup", function() {
        ...
        fetch("{{ route('system.audits.archived') }}?search=" + searchText)
...
<script>
    function toggleSort(tableId, column) {
        ...
        rows.sort((rowA, rowB) => {
            const cellA = rowA.cells[6].textContent.trim();
            const cellB = rowB.cells[6].textContent.trim();
            const dateA = new Date(cellA);
            const dateB = new Date(cellB);
