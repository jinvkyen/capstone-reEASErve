        ...
        <div class="responsive-bg md:shadow-xl w-full md:w-3/5 flex items-center justify-center p-8 relative">
            <div class="responsive-container w-full lg:p-4 sm:p-0">
                <div class="mb-12">
                    ...
                    <h2 class="lg:text-5xl sm:text-2xl md:text-6xl font-bold text-left">Email <p class="inline text-teal-800">Verification</p>
                    </h2>
                    <p class="lg:text-lg md:text-2lg sm:text-sm text-left text-200 py-2 text-sm">Enter your
                        <span class="text-opacity-60 font-semibold text-teal-600">Organizational Email Address</span>
                        <span class="lg:text-lg md:text-2lg sm:text-sm text-left text-200 py-2 text-sm"> to get a code.</span>
                    </p>
                </div>
                <form method="POST" action="{{route('system.email.send')}}">
                    @csrf
                    <!-- Enter Code -->
                    <div class="mb-8">
                    ...
                    <div class="flex justify-center items-center mt-8 space-x-4">
                        ...
                        <div class="w-full mt-12 align-center self-start lg:text-lg sm:text-sm">
                            <a id="back-login" href="{{ route('system.logout') }}" class="text-gray-600 text-md font-bold hover:text-teal-800">
