        ...
        <div class="responsive-bg md:shadow-xl w-full md:w-3/5 flex items-center justify-center p-8 relative">
            <div class="responsive-container w-full lg:p-4 sm:p-0">
                <div class="mb-12">
                    ...
                    <h2 class="lg:text-5xl sm:text-2xl md:text-6xl font-bold text-left">Welcome <p class="inline text-[#385F6E]">New User</p>
                    </h2>
                    <p class="lg:text-base md:text-2lg sm:text-xs text-left font-normal text-200 py-2 text-sm">Just one last step!</p>
                    <p class="lg:text-lg md:text-2lg sm:text-sm text-left text-200 py-2 text-sm">Enter the code received on your Organization Email.
                ...
                <form method="POST" action="{{route('verify_code')}}">
                    ...
                    <div class="text-center mb-6 mt-8" id="verify-button-div">
                        <button type="submit" class="w-80 bg-[#385F6E] hover:bg-[#243E48] text-white font-normal p-2 rounded-lg text-lg hover:shadow-lg" id="verify-btn">Verify</button>
                    </div>

                    <!-- Back to Login -->
                    <div class="w-full mt-12 align-center self-start lg:text-lg sm:text-sm">
                        <a id="back-login" href="{{ route('logout') }}" class="text-gray-600 text-md font-bold hover:text-[#243E48]">
