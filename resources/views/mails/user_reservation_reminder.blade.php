                        ...
                        <td style="padding: 40px;">
                            ...
                            <div style="background-color: #e9f7fe; border-left: 4px solid #3498db; padding: 15px; margin-bottom: 20px;">
                                <p style="margin: 0; font-size: 16px; color: #3498db;">
                                    @if ($statusId == 5)
                                    This is a friendly reminder that your borrowed item is due to be returned by <strong>{{ $convertedEndTime }}</strong>.
                                    @elseif ($statusId == 3)
                                    Your reservation has been {{ $statusState }}. Please ensure to claim the item by <strong>{{ $convertedStartTime }}</strong>.
                                    @elseif ($statusId == 4)
